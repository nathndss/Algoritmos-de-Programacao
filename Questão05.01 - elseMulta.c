/*Completar o exercício 1: 'Construa um algoritmo que a partir da leitura da velocidade e placa do carro, avise ao motorista somente se ele será multado, 
quando estiver trafegando no Eixo Rodoviário (limite de 80 km/h)' com uma mensagem para quando a condição não for satisfeita (falsa).*/
...
int main () {
	...
	else printf("\nVelocidade Permitida. Você não será multado.\n"); //Apresentará na tela ao usuário, caso a condição não tenha sido atendida.
